...
export class FelineMarket1734961016097 implements MigrationInterface {
    name = 'FelineMarket1734961016097'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_roles_role_enum" AS ENUM('admin', 'customer', 'vendor')`);
        await queryRunner.query(`CREATE TABLE "user_roles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role" "public"."user_roles_role_enum" NOT NULL DEFAULT 'customer', "assigned_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_8acd5cf26ebd158416f477de799" PRIMARY KEY ("id"))`);
